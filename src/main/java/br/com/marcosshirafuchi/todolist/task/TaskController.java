package br.com.marcosshirafuchi.todolist.task;
...
import br.com.marcosshirafuchi.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity update(@RequestBody TaskModel taskModel, @PathVariable UUID id,HttpServletRequest request){
        ...
        var idUser = request.getAttribute("idUser");
        //Verifica a tarefa pertence ao usuário logado
        if(!task.getIdUser().equals(idUser)){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST)
            .body("Usuário não tem a permissão para alterar essa tarefa");
        }
        //Source = taskModel e Target = task
